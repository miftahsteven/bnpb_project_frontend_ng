...
// img 
import authOverlay from "../../assets/images/bg-login.png";
          ...
          <div className="w-100">
            <div
              ...
              style={{
                ...
                backgroundSize: "contain", // jaga gambar proporsional dan tidak memenuhi layar
                backgroundColor: "rgba(0,0,0,0.25)" // beri kontras ringan di pinggir
              }}
            ></div>
                  ...
                  <div className="col-lg-7">
                    <div className="text-center">
                      ...
                      <div dir="ltr">
                        ...
                        {/* </Carousel> */}
                        {/* berikan informasi nama sistem disini berwarna putih "Sistem Informasi Manajemen Rambu Bencana BNPB" */}
                        <h4 className="mb-3" style={{ color: 'white' }}>
                          <span>Sistem Informasi Manajemen Rambu Bencana</span>
                          <br />
                          {/* Berikan style font warna orang sesuai logo bnpb. Untuk kata "Badan Nasional Penanggulangan Bencana" */}
                          <span style={{ color: '#f08300' }}>Badan Nasional Penanggulangan Bencana</span>
                        </h4>
                      </div>
                    </div>
                  </div>
