...
const ListRambu = () => {
    ...
    useEffect(() => {
        if (searchTerm !== undefined) {
             fetchRambu(1, pagination.pageSize, { ...filterValues, search: searchTerm, status: 'trash' });
        }
    }, [searchTerm]);
    ...
    const resetFilters = () => {
        ...
        setSearchTerm('');
        fetchRambu(1, pagination.pageSize, { status: ['trash'] });
        setIsFilterModalOpen(false);
    };
    ...
    const handleChangeStatus = async (id, status) => {
        try {
            ...
            fetchRambu(pagination.page, pagination.pageSize, { status: ['trash'] });
